# A01: Ejercicios diagramas de flujo

En esta actividad se implementan los diagramas de flujo para desarrollar diferentes algoritmos.
...
:::{dropdown} Adquirir un revista física de arte

En su cuaderno desarrolle un algoritmo para que una persona adquiera una revista física de arte. Tenga en cuenta lo siguiente:
...
:::{dropdown} Entrar a una casa con llave
En su cuaderno desarrolle un algoritmo para que una persona entre a una casa cuya cerradura está asegurada con llave. Tenga en cuenta lo siguiente:
...
:::{dropdown} Saludar y despedirse de una persona
En su cuaderno desarrolle un algoritmo para que el usuario salude y se despida de una persona. Tenga en cuenta lo siguiente:
...
:::{dropdown} Calmar a una persona
En su cuaderno desarrolle un algoritmo para calmar una persona. Tenga en cuenta lo siguiente:
